<template>
  <nav>
    ...
    <router-link to="/page4">PDF upload Interface</router-link> 
    <router-link to="/tags">Tags Listing Interface</router-link>    
    <router-link to="/viewTags"> Tags Display Interface</router-link>
  </nav>
  <router-view/>
</template>
