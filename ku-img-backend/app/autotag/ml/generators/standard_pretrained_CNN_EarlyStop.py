...
def generate_model(dataset, model_path, meta_path, img_dim=(64,64), epochs=25) : 
    ...
    # train
    model = train(model_path, X_train, Y_train, X_test, Y_test, img_dim=img_dim, epochs=epochs)
...
if __name__ == '__main__' : 
    ...
    model_output = os.path.join(current_path, 'test', 'New_finetune_models', 'chairModel.h5')
    meta_path    = os.path.join(current_path, 'test', 'New_finetune_models', 'chairModel.json')
