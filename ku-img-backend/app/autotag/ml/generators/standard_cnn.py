...
if __name__ == "__main__":
    dataset = os.path.join(
        os.environ["APP_PATH"], "test", "test_files", "chairDataset.zip"
    )
    model_output = os.path.join(
        os.environ["APP_PATH"], "test", "test_files", "chairModel.h5"
    )
    meta_path = os.path.join(
        os.environ["APP_PATH"], "test", "test_files", "chairModel.json"
    )
