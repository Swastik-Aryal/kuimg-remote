    ...
    def search(self, keyword, site_code):
        ...
        for idx, img in enumerate(imgs):
            try:
                ...
                print('[Exception occurred while collecting links from {}] {}'.format(Sites.get_text(site_code),e))

        links = self.remove_duplicates(links)

        print('Collect links done. Site: {}, Keyword: {}, Total: {}'.format(Sites.get_text(site_code), keyword, len(links))) 
        self.browser.close()
